System.register(["./application.e14c8.js"], function (_export, _context) {
  "use strict";
  ...
  function loadAmmoJsWasmBinary() {
    return fetch('./cocos-js/ammo.wasm.wasm').then(function (response) {
  ...
  return {
    setters: [function (_applicationE14c8Js) {
      createApplication = _applicationE14c8Js.createApplication;
    }],
    execute: function () {
